...
A = \{ (\numColor{red}{1}, \numColor{green}{1}), (\numColor{red}{1}, \numColor{green}{3}), (\numColor{red}{1}, \numColor{green}{5}), (\numColor{red}{2}, \numColor{green}{2}), (\numColor{red}{2}, \numColor{green}{4}), (\numColor{red}{2}, \numColor{green}{6}), (\numColor{red}{3}, \numColor{green}{1}), (\numColor{red}{3}, \numColor{green}{3}), (\numColor{red}{3}, \numColor{green}{5}), \\ (\numColor{red}{4}, \numColor{green}{2}), (\numColor{red}{4}, \numColor{green}{4}), (\numColor{red}{4}, \numColor{green}{6}), (\numColor{red}{5}, \numColor{green}{1}), (\numColor{red}{5}, \numColor{green}{3}), (\numColor{red}{5}, \numColor{green}{5}), (\numColor{red}{6}, \numColor{green}{2}), (\numColor{red}{6}, \numColor{green}{4}), (\numColor{red}{6}, \numColor{green}{6}) \} \\
\\
\text{Since the event A can be thought of as the union of all of its outcomes, and each outcome involves two independent die rolls, we can calculate P(A) as so:}
\\
...
(\numColor{red}{6}, \numColor{green}{6})\} \\
\\
\text{Since the event B can be thought of as the union of all of its outcomes, and each outcome involves two independent die rolls, we can calculate P(B) as so:}
\\
...
$$
\begin{aligned}
P(A | B) = \frac{P(B \cap A)}{P(B)} = \frac{1/6}{1/2} = \frac{1}{3} \\
= \frac{1}{3} = P(B)\ \therefore \text{A and B are independent events.}
\end{aligned}
$$
